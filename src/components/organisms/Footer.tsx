...
export function Footer({ data, className }: FooterProps) {
  return (
    <footer className={cn('bg-footer py-16', className)}>
      <div className="container mx-auto px-6 lg:px-8 space-y-12">
        {/* Top Section: Logo, Description, Contact & Cards */}
        <div className="grid gap-8 lg:grid-cols-[1fr,2fr]">
          {/* Left: Logo & Contact Info */}
          <div className="flex flex-col gap-4">
            <Logo width={187} height={34} variant="light" />
            <Small className="max-w-[240px] text-footer-text-primary">{data.description}</Small>
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr,2fr]">
          <div className="flex gap-4">
            <div className="space-y-2">
              <Small className="text-footer-text-primary">상호명</Small>
            ...
            <div className="space-y-2">
              <Small className="text-footer-text-primary">대표 CEO</Small>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-2 col-span-1">
              <Small className="text-footer-text-primary">사업자등록번호 CIN</Small>
            ...
            <div className="space-y-2 col-span-3">
              <Small className="text-footer-text-primary">주소 ADDRESS</Small>
              <Muted className="text-footer-text-secondary">{data.companyInfo.address}</Muted>
              <Muted className="text-footer-text-secondary max-w-[460px]">{data.indiaInfo.address}</Muted>
            </div>
          </div>
        </div>
